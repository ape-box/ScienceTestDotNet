...
namespace ScienceTest.Api.Clients {
    public class ApiToTestClient : IUpstreamApiClient
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly ILogger<ApiToTestClient> _logger;
        private const string ResourceUri = "api/values";
        
        public  const string ClientName = nameof(ApiToTestClient);

        public ApiToTestClient(IHttpClientFactory httpClientFactory, ILogger<ApiToTestClient> logger)
        {
